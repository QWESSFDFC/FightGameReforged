 ...
 *     <li><b>为我设奠</b>（阶段二）：处于【镣锁】时受到致命攻击会被重新召唤 ——
 *     <b>已实现</b>，逻辑在 {@link FlameReaver#tryReviveLocked}（消耗 1 层【灾难之力】与一定比例生命值，
 *     <b>重新召唤一只新的</b>容器并立即挂上【镣锁】），由 {@link FlameReaver} 处理致命攻击的那个分支调用；
 *     本类这边只需要提供"是否处于【镣锁】"的判据（{@link FlameReaver#isLocked(BrokenContainer)}）。</li>
 * </ul>
 * <p>
