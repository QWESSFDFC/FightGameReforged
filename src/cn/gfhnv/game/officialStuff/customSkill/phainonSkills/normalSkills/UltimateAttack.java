...
public class UltimateAttack extends Skill {
    ...
    public void comeToEffect(Fight fight, LivingThing user) {
        ...
        lastestOne.getiSpecialActionList().add((fight1, user1) -> {
            ...
            user1.getController().getSkills().add(new cn.gfhnv.game.officialStuff.customSkill.phainonSkills.awakenSkills.LastestAttack());
            EventBus.post(new AwakenEndEvent((Phainon) user1));
